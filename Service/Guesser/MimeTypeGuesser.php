...
namespace Youshido\GraphQLFilesBundle\Service\Guesser;
...
class MimeTypeGuesser
{
    ...
    {
        $extension = array_search($mimeType, self::$mimeTypes, false);

        if (!$extension) {
            throw new \InvalidArgumentException(sprintf('Extension not supported'));
        }
